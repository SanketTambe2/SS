...
%%
[\n] {lcnt++;ccnt++;}
[A-Za-z0-9]+ {wcnt++; ccnt=ccnt+yyleng;}
[ \t] {ccnt++;sp++;}
...
int main()
{
    yyin=fopen("xyz.txt","r");                                       //change text file name  after delete this comment
    yylex();
    printf("\n NUMBER OF LINES ARE %d ",lcnt);
    printf("\nNUMBER OF WORDS ARE %d ",wcnt);
    printf("\n Total number of charcter is %d ",ccnt );
    printf("\nNUMBER OF SPACES ARE %d ",sp);
    return 0;
}
